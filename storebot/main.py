...
class StoreBotApplication:
    ...
    async def run(self):
        print("STORE BOT STARTING..\n.\n. ")
        await self.application.bot.set_webhook(url=f'{MAIN_HOST}/storebot/{BOT_TOKEN}/webhook/', drop_pending_updates=True)
